...
sound.soundtest = {
  ...
  {name = "Icicle Maze", subtitle = "Chapter 2 Act 2", creator = "MAKYUNI", filename = "frost2.ogg", require = 13},
  {name = "Inside the mind", subtitle = "Chapter 5 test", creator = "Felix44", filename = "mind.ogg", require = 13},
